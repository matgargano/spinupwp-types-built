...
interface IEvent {
  ...
  finished_at: string; // ISO date-time string
}
...
interface IBackupDetails {
  ...
  next_run_time: string; // ISO date-time string
...
// Define other interfaces for any other nested objects that you may have.
